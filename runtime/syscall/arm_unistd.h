...
__SYSCALL(__NR_sigpending)
__SYSCALL(__NR_sethostname)
__SYSCALL(__NR_setrlimit)
__SYSCALL(__NR_getrlimit)	/* Back compat 2GB limited rlimit */
...
__SYSCALL(__NR_vhangup)
					/* 112 was sys_idle */
__SYSCALL(__NR_syscall) /* syscall to call a syscall! */
...
__SYSCALL(__NR__llseek)
__SYSCALL(__NR_getdents)
__SYSCALL(__NR__newselect)
...
__SYSCALL(__NR_ugetrlimit)	/* SuS compliant getrlimit */
__SYSCALL(__NR_mmap2)
__SYSCALL(__NR_truncate64)
__SYSCALL(__NR_ftruncate64)
__SYSCALL(__NR_stat64)
__SYSCALL(__NR_lstat64)
__SYSCALL(__NR_fstat64)
__SYSCALL(__NR_lchown32)
__SYSCALL(__NR_getuid32)
__SYSCALL(__NR_getgid32)
__SYSCALL(__NR_geteuid32)
__SYSCALL(__NR_getegid32)
__SYSCALL(__NR_setreuid32)
__SYSCALL(__NR_setregid32)
__SYSCALL(__NR_getgroups32)
__SYSCALL(__NR_setgroups32)
__SYSCALL(__NR_fchown32)
__SYSCALL(__NR_setresuid32)
__SYSCALL(__NR_getresuid32)
__SYSCALL(__NR_setresgid32)
__SYSCALL(__NR_getresgid32)
__SYSCALL(__NR_chown32)
__SYSCALL(__NR_setuid32)
__SYSCALL(__NR_setgid32)
__SYSCALL(__NR_setfsuid32)
__SYSCALL(__NR_setfsgid32)
__SYSCALL(__NR_getdents64)
__SYSCALL(__NR_pivot_root)
__SYSCALL(__NR_mincore)
__SYSCALL(__NR_madvise)
__SYSCALL(__NR_fcntl64)
...
__SYSCALL(__NR_statfs64)
__SYSCALL(__NR_fstatfs64)
__SYSCALL(__NR_tgkill)
__SYSCALL(__NR_utimes)
__SYSCALL(__NR_fadvise64)
__SYSCALL(__NR_pciconfig_iobase)
__SYSCALL(__NR_pciconfig_read)
__SYSCALL(__NR_pciconfig_write)
...
//__SYSCALL(__NR_arm_sync_file_range)
//__SYSCALL(__NR_sync_file_range2	ARM__NR_arm_sync_file_range)
