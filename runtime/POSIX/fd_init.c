...
void klee_init_fds(unsigned n_files, unsigned file_length,
  ...
  for (k=0; k < n_files; k++) {
    ...
    __create_new_dfile(&__exe_fs.sym_files[k], file_length, fname, NULL, 0, &s, 0);
  }
  
  /* setting symbolic stdin */
  if (file_length) {
    __exe_fs.sym_stdin = malloc(sizeof(*__exe_fs.sym_stdin));
    __create_new_dfile(__exe_fs.sym_stdin, file_length, "STDIN", NULL, 0, &s, 0);
  ...
  if (__exe_fs.max_failures) {
    ...
    __exe_fs.select_fail = malloc(sizeof(*__exe_fs.select_fail));
    __exe_fs.ftruncate_fail = malloc(sizeof(*__exe_fs.ftruncate_fail));
    __exe_fs.getcwd_fail = malloc(sizeof(*__exe_fs.getcwd_fail));
    __exe_fs.socket_fail = malloc(sizeof(*__exe_fs.socket_fail));
    __exe_fs.bind_fail = malloc(sizeof(*__exe_fs.bind_fail));
    __exe_fs.connect_fail = malloc(sizeof(*__exe_fs.connect_fail));
    __exe_fs.listen_fail = malloc(sizeof(*__exe_fs.listen_fail));
    __exe_fs.accept_fail = malloc(sizeof(*__exe_fs.accept_fail));
    ...
    klee_make_symbolic(__exe_fs.select_fail, sizeof(*__exe_fs.select_fail), "select_fail");
    ...
    klee_make_symbolic(__exe_fs.socket_fail, sizeof(*__exe_fs.socket_fail), "socket_fail");
    klee_make_symbolic(__exe_fs.bind_fail, sizeof(*__exe_fs.bind_fail), "bind_fail");
    klee_make_symbolic(__exe_fs.connect_fail, sizeof(*__exe_fs.connect_fail), "connect_fail");
    klee_make_symbolic(__exe_fs.listen_fail, sizeof(*__exe_fs.listen_fail), "listen_fail");
    klee_make_symbolic(__exe_fs.accept_fail, sizeof(*__exe_fs.accept_fail), "accept_fail");
  }
  ...
  if (sym_stdout_flag) {
    ...
    __create_new_dfile(__exe_fs.sym_stdout, 1024, "STDOUT", NULL, 0, &s, 0);
  ...
  for (k=0; k < n_streams; k++) {
    ...
    __create_new_dfile(&__exe_fs.sym_streams[k], stream_len, sname, __stream_fill_info, __n_stream_fill_info, &s, 1);
  }
  ...
  for (k=0; k < n_dgrams; k++) {
    ...
    __create_new_dfile(&__exe_fs.sym_dgrams[k], dgram_len, dname, __dgram_fill_info, __n_dgram_fill_info, &s, 1);
  }
